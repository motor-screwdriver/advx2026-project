...
import { type CountedItem } from '../ui/artifactsMeta'
import { PixelSprite } from '../ui/PixelSprite'
import { strings } from '../ui/strings'
import { tavernColors, WoodButton, WoodPanel } from '../ui/tavern'
import { theme } from '../ui/theme'

export type GearSlot = 'armor' | 'utilities'
...
export function slotLabel(slot: GearSlot | 'charm'): string {
...
export function CurrentArtifactSlot({
  current,
  slot,
  onUnequip,
}: {
...
export function EquipSection({
  ...
  slot: GearSlot
  onEquip: (slot: GearSlot, artifact: ArtifactId) => void
}) {
