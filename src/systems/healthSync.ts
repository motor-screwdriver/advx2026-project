 ...
 * - Android Health Connect needs a native module + platform permission → a
 *   custom dev build. The hackathon demo must run in the store Expo Go
 *   (AGENTS.md rule 7 locks the SDK to Expo Go), where it cannot load at all.
 ...
 * build with the Health Connect permission, read the asleep stages
 * overlapping [bedMin, wakeMin] and pre-fill the check-ins.
 */
