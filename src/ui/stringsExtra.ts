...
export const stringsExtra = {
  ...
  // Sleep plan
  sleep_plan_top_label: 'Sleep Oracle',
  sleep_plan_button: 'Divine my sleep',
  sleep_plan_loading: 'Luma reads the stars...',
  sleep_plan_error_title: 'The stars went quiet',
  sleep_plan_error_body: 'Could not reach the oracle. Try again later.',
  sleep_plan_expired_title: 'The mirror has clouded',
  sleep_plan_expired_body: 'Reconnect your Xiaomi account to read the stars again.',
  sleep_plan_reconnect: 'Reconnect',
  sleep_plan_retry: 'Try again',
  sleep_plan_done: 'Return to camp',
  sleep_plan_bedtime: 'Bedtime',
  sleep_plan_waketime: 'Wake up',
  sleep_plan_ritual_title: 'Pre-sleep ritual',
  sleep_plan_reason_title: 'Why this window',
  sleep_plan_stats_title: 'Your month',
  sleep_plan_nights: 'nights',
  sleep_plan_avg_duration: 'avg duration',
  sleep_plan_consistency: 'consistency',
  sleep_plan_expand: 'Show full plan',
  sleep_plan_collapse: 'Hide details',
} as const
