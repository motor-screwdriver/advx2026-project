...
describe('applyNightTurn consumables', () => {
  ...
  it('Phoenix Feather is NOT auto-used in turn (manual on death screen)', () => {
    ...
    // Feather is still in inventory (not consumed by turn)
    expect(result.game.artifacts).toContain('phoenix_feather')
  })
