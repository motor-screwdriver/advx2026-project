...
SECTIONS = ['sprites', 'sprites_1bit', 'scenes', 'icons', 'atmosphere', 'design', 'luma', 'buttons', 'audio']
...
SECTION_EXPORTS = {
    ...
    'design': ('DESIGN', 'SpriteEntry', _sprite_line),
    'luma': ('LUMA', 'SpriteEntry', _sprite_line),
    'buttons': ('BUTTONS', 'SpriteEntry', _sprite_line),
